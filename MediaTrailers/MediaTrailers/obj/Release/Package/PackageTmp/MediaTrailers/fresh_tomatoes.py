...
<head>
    <meta charset="utf-8">
    <title>Darren's Movie Page</title>
...
<nav class="navbar navbar-default" role="navigation">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Video Trailers</a>
    </div>
  ...
  <div class="modal fade" id="addMovie" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form id="movie-form" action="/get_imdb" method="post">
...
def open_movies_page(movies):
    ...
    content = render('MediaTrailers/templates/fresh_tomatoes', x)
    return content
